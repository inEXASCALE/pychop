...
if __name__ == "__main__":
    ...
    optimizer_qsgd = QuantizedSGD(model_qsgd.parameters(), lr=0.01, momentum=0.9, 
                                 exp_bits=10, sig_bits=20, rmode=1)
    ...
    optimizer_qadam = QuantizedAdam(model_qadam.parameters(), lr=0.001, 
                                   exp_bits=10, sig_bits=20, rmode=1)
    ...
    optimizer_qadagrad = QuantizedAdagrad(model_qadagrad.parameters(), lr=0.01, 
                                         exp_bits=10, sig_bits=20, rmode=1)
    ...
    optimizer_qadadelta = QuantizedAdadelta(model_qadadelta.parameters(), lr=1.0, 
                                           exp_bits=10, sig_bits=20, rmode=1)
    ...
    optimizer_qadamw = QuantizedAdamW(model_qadamw.parameters(), lr=0.001, weight_decay=1e-2, 
                                     exp_bits=10, sig_bits=20, rmode=1)
