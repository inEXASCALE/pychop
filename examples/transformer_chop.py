...
class TransformerModel(nn.Module):
    def __init__(self, src_vocab_size, tgt_vocab_size, d_model=512, nhead=8, num_encoder_layers=3, 
        ...
        self.q510 = QuantizedLayer(5, 10, rmode=1) # half precision, round to nearest ties to even
        self.q87 = QuantizedLayer(8, 7, rmode=5) # bfloat16
    ...
    def forward(self, src, tgt, src_mask=None, tgt_mask=None, src_key_padding_mask=None, tgt_key_padding_mask=None):
        ...
        src_emb = self.q87(self.pos_encoder(src_emb))
        tgt_emb = self.q510(self.pos_encoder(tgt_emb))
        
        memory = self.q510(self.encoder(src_emb, src_key_padding_mask=src_key_padding_mask))
        output = self.q510(self.decoder(
            tgt_emb,
            memory,
            tgt_mask=tgt_mask,
